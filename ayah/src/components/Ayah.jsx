  ...
  return (
    ...
    >
      <motion.div
        ...
        class="max-w-5xl  p-4 m-6  rounded-3xl shadow-xl  	"
          ...
          <div class="flex flex-col space-y-4 h-full justify-between">
            <div className="text-base text-1xl font-medium text-white text-center 	">
              ...
              <div class="flex flex-col items-center md:items-start">
                <div>
                  <h2
                    class="text-base font-medium text-xl text-white	 text-center	"
                  ...
                  <h5 class="text-base  font-mono font-medium text-xs text-white	 text-center	">
                    {" "}
                    -{" "}
                    {eng.text
                      ? eng.text
                  ...
                  <div class="pt-8"></div>
                  <h1 class="text-center  font-mono text-xs text-center text-white	">
                    {" "}
                    {surah.revelationType} Ayah{" "}
                  </h1>
                </div>
              </div>
              <h5 class="text-right pb-2.5  font-mono  text-xs text-white text-opacity-50	 text-center	">
                {" "}
              ...
              >
                <Modal.Header closeButton>
                  ...
                  <Modal.Title class="pl-3 pt-1	 text-center font-mono text-md text-center text-black	">
                    Search for an Ayah
                  </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                  <lable class="text-black text-opacity-55 ... font-mono text-sm text-centre ">
                    Surah Number
                  </lable>
                  <input
              ...
              />
              <p class="text-black text-opacity-25 ... font-mono text-sm text-centre ">
                Aayah.app
              </p>
            </div>
          </div>
